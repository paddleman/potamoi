defmodule Potamoi.Accounts.User do
  use Ecto.Schema
  ...
  def email_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :username, :full_name, :avatar_url, :bio, :background_url])
    |> validate_email(opts)
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Potamoi.Repo)
  ...
  """
  def valid_password?(%Potamoi.Accounts.User{hashed_password: hashed_password}, password)
