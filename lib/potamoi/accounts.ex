defmodule Potamoi.Accounts do
  ...
  alias Potamoi.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Potamoi.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Potamoi.Accounts.User.password_changeset/3` for a list of supported options.
