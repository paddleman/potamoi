defmodule PotamoiWeb.UserLive.Settings do
  use PotamoiWeb, :live_view

  on_mount {PotamoiWeb.UserAuth, :require_sudo_mode}
  ...
  def render(assigns) do
    ...
    <Layouts.main_app flash={@flash} current_scope={@current_scope}>
      ...
      <.form for={@email_form} class="w-1/2"  id="email_form" phx-submit="update_email" phx-change="validate_email">
        <.input
